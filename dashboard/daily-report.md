...
- **DORA**: MEDIUM (deploy 0/wk, lead 168.7h, MTTR 0h, CFR 37%)
- **CI Cost**: 1917min total, 706min wasted, ~$0/mo
...
### zentra :x:
- **Health**: 45/100
- **CI**: fail ([view](https://github.com/thonyAGP/zentra/actions/runs/23485672732))
- **Open PRs**: 6
...
### Email_Assistant :x:
- **Health**: 55/100
- **CI**: fail ([view](https://github.com/thonyAGP/Email_Assistant/actions/runs/23485582539))
- **Open PRs**: 1

### LB2I-Fiscal-Manager :x:
- **Health**: 55/100
- **CI**: fail ([view](https://github.com/thonyAGP/LB2I-Fiscal-Manager/actions/runs/23489644464))
- **Open PRs**: 2

### Livret_accueil_Au-Marais :x:
- **Health**: 55/100
- **CI**: fail ([view](https://github.com/thonyAGP/Livret_accueil_Au-Marais/actions/runs/23485496894))
- **Open PRs**: 1
