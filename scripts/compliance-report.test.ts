...
// Interfaces for test data types
...
interface RepoSummaryForAggregation {
  mergedPRs?: MergedPRStub[];
  score: number;
}

interface PRForReviewCoverage {
  reviewers?: string[];
}
...
2. **Setup CI/CD pipelines** for repos without automated testing`;
  ...
  describe('Edge Cases', () => {
    it('should handle empty repos list', () => {
      const repos: RepoSummaryForAggregation[] = [];
