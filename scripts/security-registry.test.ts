...
describe('buildRepoRisk', () => {
  ...
  it('produces a perfect scorecard for a clean repo', () => {
    const scan = scanRepo({
      scanners: [
        { scanner: 'gitleaks', status: 'clean', findings: 0, bySeverity: {} },
        { scanner: 'semgrep', status: 'clean', findings: 0, bySeverity: {} },
        { scanner: 'trivy', status: 'clean', findings: 0, bySeverity: {} },
        {
          scanner: 'jscpd',
          status: 'clean',
          findings: 0,
  ...
  it('deducts scorecard points with explanatory reasons', () => {
    const scan = scanRepo({
      scanners: [
        ...
        { scanner: 'trivy', status: 'findings', findings: 1, bySeverity: { CRITICAL: 1 } },
        {
          scanner: 'jscpd',
          status: 'findings',
          findings: 1,
  ...
  it('floors the scorecard at zero when every weakness applies', () => {
    const scan = scanRepo({
      scanners: [
        ...
        { scanner: 'semgrep', status: 'findings', findings: 9, bySeverity: { ERROR: 9 } },
        { scanner: 'trivy', status: 'findings', findings: 9, bySeverity: { CRITICAL: 9 } },
        {
          scanner: 'jscpd',
          status: 'findings',
          findings: 9,
