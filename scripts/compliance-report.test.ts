...
describe('compliance-report', () => {
  ...
  describe('PR Review Coverage', () => {
    ...
    it('should handle empty PR list', () => {
      const prs: MergedPR[] = []; // Fix: Changed unknown[] to MergedPR[]
  ...
  describe('Summary Aggregation', () => {
    ...
    it('should calculate average compliance score', () => {
      const repos: { score: number }[] = [{ score: 80 }, { score: 70 }, { score: 90 }, { score: 60 }]; // Fix: Added type annotation
...
2. **Setup CI/CD pipelines** for repos without automated testing`;
  ...
  describe('Security Findings Aggregation', () => {
    it('should aggregate findings by severity', () => {
      const findings: SecurityFinding[] = [ // Fix: Added type annotation
    ...
    it('should handle empty security findings', () => {
      const findings: SecurityFinding[] = []; // Fix: Changed unknown[] to SecurityFinding[]
