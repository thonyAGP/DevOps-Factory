...
describe('compliance-report', () => {
  ...
  describe('PR Review Coverage', () => {
    ...
    it('should handle empty PR list', () => {
      interface MergedPR { number: number; title: string; author: string; mergedAt: string; reviewers: string[]; labels: string[]; }
      const prs: MergedPR[] = [];
...
2. **Setup CI/CD pipelines** for repos without automated testing`;
  ...
  describe('Edge Cases', () => {
    it('should handle empty repos list', () => {
      interface RepoSummary { mergedPRs?: { number: number }[]; score?: number; }
