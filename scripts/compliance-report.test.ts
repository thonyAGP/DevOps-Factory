...
// Minimal interface for repos in the 'Edge Cases' test
interface RepoWithMetrics {
  mergedPRs?: MergedPR[]; // Optional, as some tests might not include it
  score: number; // Required for the reduce operation
}
