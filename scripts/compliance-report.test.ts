...
describe('compliance-report', () => {
  ...
  describe('PR Review Coverage', () => {
    ...
    it('should handle empty PR list', () => {
      type MinimalPR = { reviewers?: string[] };
      const prs: MinimalPR[] = [];
...
2. **Setup CI/CD pipelines** for repos without automated testing`;
  ...
  describe('Edge Cases', () => {
    it('should handle empty repos list', () => {
      type MinimalRepo = { mergedPRs?: { length: number }[], score?: number };
  ...
  describe('Security Findings Aggregation', () => {
    ...
    it('should handle empty security findings', () => {
      type MinimalFinding = { type: string; severity: string; };
      const findings: MinimalFinding[] = [];
